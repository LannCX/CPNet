    ...
    def synthesize(self, targets=None):
        ...
        for gs in range(g_loops):
            ...
            for it in range(self.g_steps):
                ...
                [h.syn_values() for h in self.hooks]
            ...
            print('Synthesising [{}/{}] Loss:{:.5f} Loss_oh:{:.5f} Loss_bn:{:.5f} Loss_adv:{:.5f}'.format(
                    gs+1, g_loops, avg_loss.avg, avg_loss_oh.avg, avg_loss_bn.avg, avg_loss_adv.avg))
